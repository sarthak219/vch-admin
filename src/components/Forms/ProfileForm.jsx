    ...
    <div className='profile-form-container'>
        ...
        <form>
                    ...
                    <fieldset id="vSite">
                        <div className="d-flex align-items-center">
                            ...
                            <div className="form-check-inline">
                                <input className="form-check-input" value={"Yes"} type="radio" name="vSite" id="vSiteYes" onChange={(e)=>{setSite(e.target.value)}}/>
                                <label className="form-check-label gray" htmlFor="vSiteYes">
                                    L
                                </label>
                            </div>
                            <div className="form-check-inline">
                                <input className="form-check-input" value={"No"} type="radio" name="vSite" id="vSiteoNo" onChange={(e)=>{setSite(e.target.value)}}/>
            ...
            <div className="form-check mb-4">
                <input className="form-check-input" type="checkbox" id="selfReportConsent" {...selfReport} onChange={(e)=>{setSelfReport(e.target.checked)}}/>
